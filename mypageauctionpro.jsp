     ...
     <div class="listInfoWrap">
        <div class="list_sort_type">
            <div class="sort">
                ...
                <a href="javascript:itemList.searchParam('orderby','endtime');" class="">마감임박순</a>
                <a href="javascript:itemList.searchParam('orderby','priceasc');" class="">낮은가격순</a>
                <a href="javascript:itemList.searchParam('orderby','pricedesc');" class="">높은가격순</a>
                <a href="javascript:itemList.searchParam('orderby','biddesc');" class="">입찰수높은순</a>
                <a href="javascript:itemList.searchParam('orderby','bidasc');" class="">입찰수낮은순</a>
                <a href="javascript:itemList.searchParam('orderby','starttime');" class="">신상품순</a>
            </div>
           <!--  <div class="type">
