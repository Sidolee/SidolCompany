			...
			<div class="col-md-4">
				...
				<div id="sidebar" class="well sidebar-nav">
					...
					<ul class="nav nav-pills nav-stacked">
						...
						<li class="active nav-link"><a href="mypageaccount.do">계좌관리</a></li>
				...
				<div class="">
					<form class="_passwordConfirmForm" action="/login/userModify.pang"
						...
						<input id="confirmTicket" name="confirmTicket" value=""
							type="hidden">
						<h1 class="usermodify-auth-title">계좌관리</h1>

						<table class="table table-striped usermodify-table">
							<tbody>
								<tr>
									<th scope="row" style="background-color: #f8f9fa;">계좌번호</th>
									<td style="background-color: white;">682402-01-410xxx </td>
									<td style="background-color: white;">국민은행 </td>
									<td style="background-color: white;"><button>계좌변경</button> </td>
									
								</tr>
								<tr>
									<th scope="row" style="background-color: #f8f9fa;">잔액</th>
									<td style="background-color: white;">1,000,000,000 원</td>
									<td>
                            			<input class="form-control usermodify-auth-password-tf member__input-border"  style="background-color: white;">
                        			</td>
                        			<td style="background-color: white;"><button>충전하기</button> </td>
                        			
								</tr>
								<tr>
									<th scope="row" style="background-color: #f8f9fa;">시돌페이 계좌</th>
									<td style="background-color: white;">222402-01-410xxx </td>
