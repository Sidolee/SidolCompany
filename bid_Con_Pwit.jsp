		...
		<div class="pagetitle">
			...
			<nav>
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="eve_P.do">이벤트 관리</a></li>
				...
				<!-- Page content-->
					<div class="row row-cols-12">
						...
						<div class="col-4">
							...
							<div class="card mb-4">
								<div class="card-body">
									...
									<a class="btn ms-lg-2 btn-primary" href="#1">이미지 가져오기</a><a
										class="btn ms-lg-2 btn-primary" href="#!">이미지 삭제하기</a>
									<div class="row mb-4"></div>
									<div class="card mb-3">
										<div class="card-body bg-warning">
											<h4 class=" text-center">판매자 정보</h4>
										</div>
									</div>
									<div class="row"></div>
								</div>
						...
						<div class="col-4">
							...
							<div class="card mb-4">
								<div class="card-header">
									<input><a class="btn ms-lg-5 btn-primary" href="#!">찜하기</a>
								</div>
								<div class="card-body">
									<div class=""></div>
						...
						<div class="col-4">
							...
							<!-- Side widget-->
							<div class="card mb-4">
								<div class="card-header">최고가와 최소가</div>
								<div class="card-body">
									<input> <br> <input>
								</div>
							</div>
							<div class="card mb-4">
								<div class="card-body">
									<a class="btn ms-lg-5 btn-primary" href="#1">수정하기</a> <a
										class="btn ms-lg-5 btn-primary" href="#!">삭제하기</a>
								</div>
							</div>
