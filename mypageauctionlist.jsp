...
<body>
	...
	<!-- (col-md-4")사이드 메뉴 + (col-md-8)경매완료리스트 입력-->
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				...
				<div id="sidebar" class="well sidebar-nav">
					...
					<ul class="nav nav-pills nav-stacked">
						<li class="nav-link"><a href="mypageauctionpro.do">진행중인
								경매</a></li>
						<li class="active nav-link"><a href="mypageauctionlist.do">경매내역</a></li>
			...
			<div class="col-md-8 userinfo">
				...
				<div class="">
					<form class="auctionlistform" action=" " method="post">
						<h1 class="usermodify-auth-title">경매내역</h1>
						<br></br>
						<tr>
							<td><input></input>
							<button>검색</button></td>
								...
								<div class="well">
									...
									<div class="list-group">
										<a href="#" class="list-group-item">
											...
											<div class="col-md-6">
												<h4 class="list-group-item-heading">2023.10.25 낙찰
												</h4>
