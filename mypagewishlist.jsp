			...
			<div class="col-md-4">
				...
				<div id="sidebar" class="well sidebar-nav">
					...
					<ul class="nav nav-pills nav-stacked">
						...
						<li class="active nav-link"><a href="mypagewishlist.do">찜 리스트</a></li>
					</ul>
				</div>
			</div>
			<div class="col-md-8 userinfo">
				...
				<div class="">
					<form class="auctionlistform" action=" " method="post">
						<h1 class="usermodify-auth-title">찜 리스트</h1>
						<br></br>
						
						<div class="container">
							<div class="row">
								<div class="well">
									<h1 class="text-center">찜 리스트</h1>
									<div class="list-group">
										<a href="#" class="list-group-item">
											...
											<div class="col-md-6">
												...
												<p class="list-group-item-text">남은시간 : 50시간 30분 23초</p>
												<br></br>
												<p class="list-group-item-text">지정가 : 1,000,000,000 원</p>
											</div>
											<div class="col-md-3 text-center">
												<button type="button"
													class="btn btn-default btn-lg btn-block">경매참여하기
												</button>
												<button type="button"
													class="btn btn-default btn-lg btn-block">삭제
												</button>
												<div class="stars">
